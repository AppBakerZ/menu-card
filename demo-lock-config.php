...
/**Set Plugin Name*/
$demovars['plugin_title'] = 'Menu Card';

/**Set the file name(s) that are used to directly access your plugin */
$demovars['plugin_file'] = array('menu-card');
...
$demovars['getvar']['page'] = 'menu-card-options';
...
<p style="font-size: 15px; font-weight: bold; line-height: 22px;">
	Within this demo area, you have access to all the capabilites available in Menu Card. 
...
/**Set footer text*/
$demovars['footer'] = sprintf( __( 'You are currently using a demo of Menu Card. Like what you see? <a href="%s" title="Click here to download!" target="_blank">Download My Plugin today!</a>' ), 'http://mypluginurl.com' );
...
$demovars['allow_capabilites'] = array('manage_options_menu-card');
...
$demovars['menu_modifications'] = array(
    '80' => array(1, 'manage_options_menu-card')
  );
